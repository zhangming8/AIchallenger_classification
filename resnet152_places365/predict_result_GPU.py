...
result = []
test_dir = my_root + 'ai_challenger_scene_test_a_20170922/scene_test_a_images_20170922/'
net_file = my_root + 'resnet152_places365/deploy_resnet152_places365.prototxt' ###### deploy file
caffe_model = my_root + 'resnet152_places365/snapshot/my_iter_20000.caffemodel' ###### trained  caffe model
...
with open(my_root + 'resnet152_places365/submit.json', 'w') as f:
    json.dump(result, f)
