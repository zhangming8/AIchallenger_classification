...
#test_dir = '/data/face_recongize/aichallenger/ai_challenger_scene_test_a_20170922/scene_test_a_images_20170922/'
net_file = '/data/face_recongize/aichallenger/resnet152_places365/deploy_resnet152_places365.prototxt'
caffe_model = '/data/face_recongize/aichallenger/resnet152_places365/snapshot/no_lmbd_iter_45000.caffemodel'
...
with open('/data/face_recongize/aichallenger/treated_val_exp_submit.json', 'w') as f:
    json.dump(result, f)
