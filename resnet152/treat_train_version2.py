...
tra_label_dir = '/data/zhangming/aichallenger/ai_challenger_scene_train_20170904/dir_train_CA.txt' # train label
# treated train file
treated_tra_dir = '/data/zhangming/aichallenger/aichallenger_train_treated/train/' #treated train dir
treated_train_label_dir = '/data/zhangming/aichallenger/aichallenger_train_treated/treated_train_label.txt' #treated label
